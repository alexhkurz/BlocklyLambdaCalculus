...
Blockly.Blocks['use_named_function'] = {
  init: function() {
    this.appendDummyInput()
        .appendField("use function")
        .appendField(new Blockly.FieldTextInput("f"), "NAME");
    this.setOutput(true, "exp");
    this.setColour(330);
    this.setTooltip("");
...
Blockly.JavaScript['named_function'] = function(block) {
  var function_name = block.getFieldValue('NAME');
  var var_name = Blockly.JavaScript.valueToCode(block, 'VAR', Blockly.JavaScript.ORDER_NONE);
  var expr_code = Blockly.JavaScript.valueToCode(block, 'EXPR', Blockly.JavaScript.ORDER_NONE);
  var code = 'var ' + function_name + ' = (' + var_name + ' => ' + expr_code + ');\n';
  return code;
};

Blockly.JavaScript['use_named_function'] = function(block) {
  var function_name = block.getFieldValue('NAME');
